...
@Feature(name = "隐藏发送消息头像", categories = ["聊天"], description = "隐藏自己发出的消息的用户头像 (Telegram 风格)")
object HideOutgoingMessagesAvatar : SwitchFeature(), WeChatMessageViewApi.ICreateViewListener {
